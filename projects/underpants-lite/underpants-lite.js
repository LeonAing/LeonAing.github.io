...
_.first = function(array, number){
    ...
    if (Array.isArray(array) === false){
        return [];
    } else if(Array.isArray(array) === true && typeof number === "number" && number > -1 && number < array.length){
        for(var i = 0; i< number; i++){
            newArr.push(array[i]);
        }
    } else if(number > array.length){
        return array;
    } else if (typeof number !== "number" || number === false){
        return array[0];
    }
    return newArr;
...
_.partition = function(array, func){
    ...
    _.reject(array, function(element, index, collection){
        if (!func(element, index, collection)){
...
_.every = function(collection, func){
    ...
    else if (_.contains(_.map(collection, func), false)) {
        return false; 
    } else {
        return true;
    }
...
_.some = function(collection, func){
    ...
    else if (_.contains(_.map(collection, func), true)) {
        return true; 
    } else {
        return false;
    }
